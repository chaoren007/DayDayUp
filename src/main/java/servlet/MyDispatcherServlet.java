...
public class MyDispatcherServlet extends HttpServlet {
    ...
    private static final Logger log = Logger.getLogger("init");
    ...
    private void doAutowired() {
        ...
        doSomeThing(ioc.entrySet());

    }
    private void doSomeThing(Set<Map.Entry<String, Object>> entrySet) {
    ...
    private void doAutowired2() {
        ...
        for (Map.Entry<String, Object> entry : controllerMap.entrySet()) {
           doSomeThing(controllerMap.entrySet());
        }
    }
